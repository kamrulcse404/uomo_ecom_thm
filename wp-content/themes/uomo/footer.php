         ...
         <div class="row row-cols-lg-5 row-cols-2">
             ...
             <div class="footer-column footer-newsletter mb-4 mb-lg-0">
                 ...
                 <div class="mt-4 pt-3">
                     ...
                     <p class="mt-2">
                         <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/payment-options.png" alt="Acceptable payment gateways" class="mw-100">
                     </p>
                 </div>
             </div><!-- /.footer-column -->
         </div><!-- /.row-cols-5 -->
 ...
 <!----------------- Newsletter Popup ----------------->
 <!-- <div class="modal fade" id="newsletterPopup" tabindex="-1" aria-labelledby="newsletterPopupModal" aria-hidden="true">
          ...
          <div class="col-md-6 p-0 d-none d-md-block">
            <div class="newsletter-popup__bg h-100 w-100">
              <img loading="lazy" src="<? php // echo get_template_directory_uri(); 
                                        ?>/images/newsletter-popup.jpg" class="h-100 w-100 object-fit-cover d-block" alt="" />
            </div>
          </div>
 ...
 <!-- <script src="<?php echo get_template_directory_uri(); ?>/js/plugins/sticky.min.js"></script> -->
