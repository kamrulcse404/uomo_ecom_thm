    ...
    <div class="footer-middle container">
        <div class="row row-cols-lg-5 row-cols-2">
            <div class="footer-column footer-store-info mb-4 mb-lg-0">
                <div class="logo">
                    <a href="<?php echo home_url(); ?>">
                        <img src="<?php global $uomo;
                                    echo $uomo['footer-logo']['url'] ?>" alt="Uomo" class="logo__image d-block" />
                    </a>
                </div><!-- /.logo -->
                <p class="footer-address"><?php global $uomo;
                                            echo $uomo['footer-left-address'] ?></p>

                <p class="m-0">
                    <strong class="fw-medium"><?php global $uomo;
                                                echo $uomo['footer-left-email'] ?></strong>
                </p>
                <p>
                    <strong class="fw-medium"><?php global $uomo;
                                                echo $uomo['footer-left-phone'] ?></strong>
                </p>

                <ul class="social-links list-unstyled d-flex flex-wrap mb-0">
                    <li>
                        <a href="<?php global $uomo;
                                    echo $uomo['footer-facebook-url'] ?>" class="footer__social-link d-block">
                    ...
                    <li>
                        <a href="<?php global $uomo;
                                    echo $uomo['footer-twitter-url'] ?>" class="footer__social-link d-block">
                    ...
                    <li>
                        <a href="<?php global $uomo;
                                    echo $uomo['footer-instagram-url'] ?>" class="footer__social-link d-block">
                    ...
                    <li>
                        <a href="<?php global $uomo;
                                    echo $uomo['footer-youtube-url'] ?>" class="footer__social-link d-block">
                    ...
                    <li>
                        <a href="<?php global $uomo;
                                    echo $uomo['footer-pinterest-url'] ?>" class="footer__social-link d-block">
            ...
            <div class="footer-column footer-newsletter mb-4 mb-lg-0">
                <h5 class="sub-menu__title text-uppercase"><?php global $uomo;
                                                            echo $uomo['footer-left-title'] ?></h5>
                <p><?php global $uomo;
                    echo $uomo['footer-left-desc'] ?></p>
                ...
                <div class="mt-4 pt-3">
                    <strong class="fw-medium"><?php global $uomo;
                                                echo $uomo['footer-payment-title'] ?></strong>
                    <p class="mt-2">
                        <img loading="lazy" src="<?php global $uomo;
                                                    echo $uomo['footer-left-payment-logo']['url'] ?>" alt="Acceptable payment gateways" class="mw-100">
                    </p>
                </div>
            </div><!-- /.footer-column -->
        </div><!-- /.row-cols-5 -->
                    ...
                    "prevEl": ".modal-dialog.quick-view .product-single__media .swiper-button-prev"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/products/quickview_1.jpg" alt="" />
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/products/quickview_2.jpg" alt="" />
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/products/quickview_3.jpg" alt="" />
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/products/quickview_4.jpg" alt="" />
                                </div>
                            </div>
...
<!-- Mirrored from uomo-html.flexkitux.com/Demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Dec 2023 06:37:03 GMT -->
